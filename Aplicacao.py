...
#---------------------------CARREGANDO O MODELO-------------------------------------------
#Carregar o modelo
Modelo = joblib.load('Modelo floresta aleatória_v100.pkl')
...
def Funcao_01(area, rooms, bathroom, parking_spaces, floor, animal, furniture, hoa, property_tax):
    ...
    try:
        ...
        #Inserir o valor da Previsao
        Lista.append( str(Previsao) )

        # Transformando a lista em string e Concatenando as listas
        Input = ''
        for Valor in Lista:
